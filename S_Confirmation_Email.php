...
$message = '<body style="background-color: Black;">
		<table cellpadding= "10" style="color: Green; text-align: center; height: 100%; width: 50%; font-family: Verdana, Geneva, sans-serif; font-size: 18px; margin-left: auto; margin-right: auto;">
			<tr>
				<td>
	<h3 style="font-size: 25px;">This email has been sent because it has been listed as the student email for an account at www.forum.sandboxsalinas.com. </h3>
				</td>
			</tr>
			<tr>
				<td>
	...
	Anyway, if this email reached you by mistake, please click this button:
		<form method="POST" action="http://forum.sandboxsalinas.com/S_Bounce1.php">
		<input type="hidden" name="code" value='. $student_e_code . '>
		<input type="hidden" name="email" value=' . $to . '>
		<input type="submit" value="Wrong_Email" name="Wrong_Email">
		</form>
				</td>
			</tr>
			<tr>
	...
	If this is the correct email address, please confirm it for us: 
		...
		<input type="hidden" name="code" value=' . $student_e_code . '>
		<input type="hidden" name="email" value=' . $to . '>
		<input type="submit" value="Confirm_Email" name="Confirm_Email">
		</form>
				</td
			</tr>
			<tr>
